            ...
            <div className="flex min-w-[500px] gap-2">
                {forecast.map((day, index) => {
                    ...
                    return (
                        <div
                            key={index}
                            className="flex flex-1 flex-col items-center rounded-lg bg-slate-50 p-3 text-center transition-colors hover:bg-slate-100 dark:bg-slate-700/30 dark:hover:bg-slate-700/50"
                        >
                            <div className="text-sm font-medium text-slate-800 dark:text-slate-200">{getDayName(date)}</div>
                            <div className="my-2 text-3xl">{weatherIcon}</div>
